...
<p class="muted note">
	Чат заводится сам, когда бота в него добавляют. Раз в шесть часов права сверяются опросом:
	Telegram сообщает о выходе бота ровно один раз, и пропущенный апдейт иначе оставил бы чат
	«живым» навсегда.
</p>
	...
	{#if data.list?.items?.length}
		<div class="table-scroll">
			<table>
				<thead>
					<tr>
						<th>Чат</th><th>Вид</th><th>Бот</th><th>Доставка</th>
